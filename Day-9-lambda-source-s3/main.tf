...
resource "aws_s3_bucket" "lambda_bucket" {
  bucket = "yalagandula95"  # must be globally unique
}
...
resource "aws_s3_object" "lambda_zip" {
  ...
  source = "C:/terraform-1030am/terraform-shankar/Day-9-lambda-source-s3/lambda_function.zip" # local path to your zip file
